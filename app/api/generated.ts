...
/**
 * Lifecycle status of a creator collection.
 */
...
export type IssueAuthorizationRequestDetail = IssueAuthorizationRequest & {
  ...
  /** Optional note added when approving or rejecting. */
  decisionNote?: string;
...
/**
 * An organization's relationship to a credential collection — either owned or authorized.
 */
...
/**
 * Returns the learner's full journey for a badge — progress across orgs, and any assertions earned. Used for shareable certificate pages.
...
/**
 * @summary Get a single issue-authorization request by ID
 */
...
/**
 * Returns requests submitted by other orgs wanting to use this org's published collections.
...
export const getGetIssueAuthorizationResponseMock = (): IssueAuthorizationRequestDetail => ({...{id: faker.string.alpha({length: {min: 10, max: 20}}), collectionId: faker.string.alpha({length: {min: 10, max: 20}}), requestingOrgId: faker.string.alpha({length: {min: 10, max: 20}}), status: faker.helpers.arrayElement(['pending','approved','rejected'] as const), message: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), createdAt: faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z', undefined])},...{requestingOrg: faker.helpers.arrayElement([{name: faker.string.alpha({length: {min: 10, max: 20}}), about: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), location: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), website: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined])}, undefined]), collection: faker.helpers.arrayElement([{id: faker.string.alpha({length: {min: 10, max: 20}}), name: faker.string.alpha({length: {min: 10, max: 20}}), description: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), createdByOrgId: faker.string.alpha({length: {min: 10, max: 20}}), imageUrl: faker.helpers.arrayElement([faker.internet.url(), undefined]), badgeCount: faker.helpers.arrayElement([faker.number.int({min: undefined, max: undefined}), undefined]), published: faker.helpers.arrayElement([faker.datatype.boolean(), undefined]), status: faker.helpers.arrayElement([faker.helpers.arrayElement(Object.values(CollectionStatus)), undefined]), createdAt: faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z', undefined]), updatedAt: faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z', undefined])}, undefined]), decisionNote: faker.helpers.arrayElement([faker.string.alpha({length: {min: 10, max: 20}}), undefined]), decidedAt: faker.helpers.arrayElement([faker.date.past().toISOString().slice(0, 19) + 'Z', undefined])},})
